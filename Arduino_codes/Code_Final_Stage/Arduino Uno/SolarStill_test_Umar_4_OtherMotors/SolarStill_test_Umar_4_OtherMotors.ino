...
/*july 10 2021 - > day_of_year= 191*/
const unsigned char PTh = 13; //present time in hours*
const unsigned char PTm = 41; //present time in minutes*
const unsigned int day_of_year = 191; //day of the year of the experiment*
...
double mirror_pos_x[NumOfMirrorUnits] = {  18.75, 18.75, 28.3125, 28.3125, 28.3125}; //x position (in inch) of center pt. of flat mirrors
