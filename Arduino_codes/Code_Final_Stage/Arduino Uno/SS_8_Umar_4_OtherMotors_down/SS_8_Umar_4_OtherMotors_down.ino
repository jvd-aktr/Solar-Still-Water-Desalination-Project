...
#define timezone -7; //timezone in hour from UTC (Mountain Daylight Time)
...
const unsigned char PTm = 55; //present time in minutes*
const unsigned int day_of_year = 204; //day of the year of the experiment*

double h = 27.25; //height(in inch) of convex mirror focal point from the origin
//(centre point of the base on which these mirror units are intalled)
const unsigned char NumOfMirrorUnits = 5; //number of total mirror units

const unsigned char mirror_alt_offset[NumOfMirrorUnits] = {0, 0, 0, 0, 0}; //mirror altitude angle offset
const unsigned char mirror_azi_offset[NumOfMirrorUnits] = {0, 0, 0, 0, 0}; //mirror azimuth angle offset

//pulse range of mirror motors for mirror 1-6
const unsigned int mirror_alt_pulse_0[NumOfMirrorUnits] = {610,550,650,610,550};  
const unsigned int mirror_alt_pulse_180[NumOfMirrorUnits] = {2420,2345,2480,2495,2355};
const unsigned int mirror_azi_pulse_0[NumOfMirrorUnits] = {470,470,520,710,675};
const unsigned int mirror_azi_pulse_180[NumOfMirrorUnits] = {2300,2335,2355,2585,2245};
...
double mirror_pos_x[NumOfMirrorUnits] = {  18.75, 18.75, 28.3125, 28.3125, 28.3125}; //x position (in inch) of center pt. of flat mirrors (mirror7-11)
double mirror_pos_y[NumOfMirrorUnits] = { 9.375, -9.375, -18.9357, 0, 18.9357}; //y position (in inch) of center pt. of flat mirrors
double mirror_pos_z[NumOfMirrorUnits] = {0}; //z position (in inch) of center pt. of flat mirrors

// x & y position of target point is "0"
double target_pos_z[NumOfMirrorUnits] = {h, h, h, h, h}; //z position of target_point
...
//Azimuth Greeen wire
const unsigned char AltServoPins[NumOfMirrorUnits] = {2,3,4,11,6}; //, 13, 15, 18, 19, 21}; //initiallzing servo pins for altitude motors
const unsigned char AziServoPins[NumOfMirrorUnits] = {8,9,10,5,12}; //, 14, 16, 17, 20, 22}; //initiallzing servo pins for azimuth motors
