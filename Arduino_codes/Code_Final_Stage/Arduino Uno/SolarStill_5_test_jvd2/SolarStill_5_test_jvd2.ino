...
//this update: 07/12/2021
//For 5 mirror units (7-11)
...
/*july 13 2021 - > day_of_year= 194*/
const unsigned char PTh = 14; //present time in hours*
const unsigned char PTm = 12; //present time in minutes*
const unsigned int day_of_year = 194; //day of the year of the experiment*
...
const char mirror_alt_offset[NumOfMirrorUnits] = {0,0,0,3,-2}; //mirror altitude angle offset
const char mirror_azi_offset[NumOfMirrorUnits] = {0,0,0,0,3}; //mirror azimuth angle offset
...
double mirror_pos_x[NumOfMirrorUnits] = { 19.0625, 19.0625, 28.625, 28.625, 28.625}; //x position (in inch) of center pt. of flat mirrors
double mirror_pos_y[NumOfMirrorUnits] = { 10.75, -6.75, -17.5, 0, 18.25}; //y position (in inch) of center pt. of flat mirrors
double mirror_pos_z[NumOfMirrorUnits] = { 9.25, 9.25, 9.375, 9.3125, 9.3125}; //z position (in inch) of center pt. of flat mirrors
...
//Azimuth Greeen wire
const unsigned char AltServoPins[NumOfMirrorUnits] = {2, 3, 4, 11, 6}; //initiallzing servo pins for altitude motors
const unsigned char AziServoPins[NumOfMirrorUnits] = {8, 9, 10, 5, 12}; //initiallzing servo pins for azimuth motors
  ...
  if (CurrTime - LastTime > 5000)                                   //routine to be called after every five seconds
  {
    for (int i = 0; i < NumOfMirrorUnits; i++)
    {
      ...
      //      Serial.println("Mirror 3 Azi motor");
            Serial.println(mirror_azi[4] + mirror_azi_offset[4]);
