...
void loop()
{
  ...
  Serial.print("Sun Altitude = "); Serial.print(alpha * r2d); Serial.print("Sun Azimuth = "); Serial.print(beta * r2d); Serial.print("Declination = "); Serial.println(decl * r2d);

  Serial.print("Sr.\t\t"); Serial.print("Altitude\t\t"); Serial.print("Azimuth\t\t\n");
  for (int i = 0; i < NumOfMirrorUnits; i++)
  {
    Serial.print(i); Serial.print("\t\t"); Serial.print(mirror_alt[i]*r2d); Serial.print("\t\t"); Serial.print(mirror_azi[i]*r2d); Serial.print("\t\t\n");
  }
  delay(5000);
