...
const unsigned char PTm = 36; //present time in minutes*
const unsigned int day_of_year = 194; //day of the year of the experiment*

double h = 35.5; //height(in inch) of convex mirror focal point from the origin= 30.125
...
const char mirror_alt_offset[NumOfMirrorUnits] = {0,0,3,0,0,0}; //mirror altitude angle offset
