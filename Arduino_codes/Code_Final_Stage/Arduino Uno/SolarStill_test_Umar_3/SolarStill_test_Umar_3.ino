...
const unsigned char PTh = 12; //present time in hours*
const unsigned char PTm = 50; //present time in minutes*
...
const unsigned char mirror_alt_offset[NumOfMirrorUnits] = {0, 0, 0, 0, 0, 0}; //mirror altitude angle offset
const unsigned char mirror_azi_offset[NumOfMirrorUnits] = {0, 0, 0, 0, 0, 0}; //mirror azimuth angle offset

//pulse range of mirror motors for mirror 1-6
const unsigned int mirror_alt_pulse_0[NumOfMirrorUnits] = {520,578,460,585,540,505};  
const unsigned int mirror_alt_pulse_180[NumOfMirrorUnits] = {2350,2380,2350,2390,2410,2270};
const unsigned int mirror_azi_pulse_0[NumOfMirrorUnits] = {490,490,605,550,490,500};
...
//Azimuth Greeen wire
const unsigned char AltServoPins[NumOfMirrorUnits] = {4, 6, 7, 8, 10, 9}; //, 13, 15, 18, 19, 21}; //initiallzing servo pins for altitude motors
const unsigned char AziServoPins[NumOfMirrorUnits] = {11, 12, 13, 2, A0, 3}; //, 14, 16, 17, 20, 22}; //initiallzing servo pins for azimuth motors
