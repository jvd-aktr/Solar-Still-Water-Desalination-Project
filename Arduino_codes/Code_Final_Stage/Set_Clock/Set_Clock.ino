...
void setup() {
  ...
  clock.setMonth(9);
  clock.setDate(15);
  clock.setDoW(5); //starting from sunday (for sunday put 1)
  clock.setHour(10);
  clock.setMinute(8);
  clock.setSecond(00);
 //%%%%%%%To reset the clock, you must uncomment this section and upload it. After 1st upload, make them comment again and upload it again%%%%%%%//
 //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
