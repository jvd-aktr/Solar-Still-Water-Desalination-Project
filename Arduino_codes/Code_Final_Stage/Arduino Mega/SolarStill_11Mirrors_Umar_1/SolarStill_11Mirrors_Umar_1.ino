...
//this update: 07/21/2021
//First code after Arduino Mega
...
const unsigned char PTh = 11; //present time in hours*
const unsigned char PTm = 30; //present time in minutes*
...
//Azimuth Greeen wire
const unsigned char AltServoPins[NumOfMirrorUnits] = {2, 3, 4, 5, 7, 6, 8, 9, 10, 40, 12}; //initiallzing servo pins for altitude motors
const unsigned char AziServoPins[NumOfMirrorUnits] = {31, 32, 33, 34, 36, 35, 37, 38, 39, 11, 41}; //initiallzing servo pins for azimuth motors
