...
//---------UNIT#3-------------
  ...
  int theta3= theta3_d*((2394-544)/180); //angle for arduino
  int a3= 90*((2394-544)/180) -((theta3-alpha)/2); //intial angle for altitude adjustment (for arduino)
  int b3= 45*((2394-544)/180) +(beta/2); //intial angle for azimuthal adjustment (for arduino)
