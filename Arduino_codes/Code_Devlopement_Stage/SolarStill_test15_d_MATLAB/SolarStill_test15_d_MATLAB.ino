 ...
 * Link for solar information:(1) https://www.esrl.noaa.gov/gmd/grad/solcalc/ ****use this one
                              ...
                              (4) https://www.timeanddate.com/sun/usa/las-cruces
 * Las Cruces Coordinate: 32.287989° N(+), -106.75385° W (-)
 ...
 * offset_azi_testunit=16;  offset_alt_testunit=24; (in degree)
  */
 
          /*june 17 2021 - > day_of_year= 168*/
 int PTh=14;  //present time in hours*
...
//---------------UNIT#4-----------------
  ...
  int a4_d=0; //initiation of variable "a4_d" (alt adjustment angle(in degree))
  int b4_d=0; //initiation of variable "b4_d" (azi adjustment angle(in degree))
  int offset_alt4=24; //offset of altitude adjustment (in degree) for unit#4
  int offset_azi4=16; //offset of azimuth adjustment (in degree) for unit#4
  int a4_d_offset= offset_alt4 +a4_d; //intial angle for altitude adjustment with offset for unit#4
  int b4_d_offset= offset_azi4 +b4_d; //intial angle for azimuth adjustment with offset for unit#4
